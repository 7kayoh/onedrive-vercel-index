...
module.exports = {
  ...
  googleFontSans: 'Red Hat Display',
  // googleFontMono - the monospace font used in onedrive-vercel-index.
  googleFontMono: 'Fira Mono',
  // googleFontLinks -  an array of links for referencing the google font assets.
  googleFontLinks: ['https://fonts.googleapis.com/css2?family=Fira+Mono&family=Red+Hat+Display:wght@400;500;700&display=swap'],
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/koterahq/',
    },
    {
      name: 'GitLab',
